...
# ============================================================
# FLIGHT2WORLD V10 - CONFIDENCE / ERROR LAYER
#
...
DIAG = os.path.join(BASE, "test", "fused_v10_diag.json")

INPUT_CLOUD = os.path.join(BASE, "test", "fused_v10_clean.ply")
OUTPUT_PLY = os.path.join(BASE, "test", "fused_v10_confidence.ply")
OUTPUT_JSON = os.path.join(BASE, "test", "fused_v10_confidence.json")
...
def main():
    print("=" * 70)
    print("FLIGHT2WORLD V10 - CONFIDENCE / ERROR LAYER")
    print("=" * 70)
    ...
    render_confidence(P, confidence, C,
                      os.path.join(OUTPUT_RENDER_DIR, "v10_conf_top.png"),
                      view="top")
    render_confidence(P, confidence, C,
                      os.path.join(OUTPUT_RENDER_DIR, "v10_conf_side.png"),
                      view="side_y")
    render_confidence(P, confidence, C,
                      os.path.join(OUTPUT_RENDER_DIR, "v10_conf_oblique.png"),
                      view="oblique")
