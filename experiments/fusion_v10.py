...
# ============================================================
# FLIGHT2WORLD V10
# TRACK-ANCHORED FUSION (DEPTH-ANYTHING-V2-BASE)
#
# HYPOTHESIS
# ----------
...
OUTPUT_RAW = os.path.join(BASE, "test", "fused_v10.ply")
OUTPUT_CLEAN = os.path.join(BASE, "test", "fused_v10_clean.ply")
OUTPUT_DIAG = os.path.join(BASE, "test", "fused_v10_diag.json")
...
print()
print("=" * 70)
print("FLIGHT2WORLD V10")
print("TRACK-ANCHORED FUSION (DEPTH-ANYTHING-V2-BASE)")
print("=" * 70)
print()
...
print()
print("Loading Depth Anything V2 Base on MPS...")
